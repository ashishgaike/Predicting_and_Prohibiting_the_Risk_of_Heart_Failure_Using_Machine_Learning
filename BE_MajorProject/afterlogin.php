...
<html lang="en">
  ...
  <body id="top">
    ...
    <div class="dropdown">
		  ...
		  <button class="btn btn-primary">Hello! <span> <?php echo $_SESSION['user_name'] ?></span></button>
      ...
      <article>
        <section class="section hero" aria-label="hero" id="home" data-section
          ...
          <div class="container">
            ...
            <a href="../loading/load.php" class="btn btn-secondary">Start Course</a>
            ...
            <ul class="grid-list">
              ...
              <li>
                <div class="service-card">
                  ...
                  <h3 class="h3">
                    <a href="../loading/load.php" class="card-title">Women’s Course</a>
                  </h3>
                  ...
                  <a href="../loading/load.php" class="btn btn-secondary">
              ...
              <li>
                <div class="service-card active">
                  ...
                  <h3 class="h3">
                    <a href="../loading/load.php" class="card-title">Basic Course</a>
                  </h3>
              ...
              <li>
                <div class="service-card">
                  ...
                  <h3 class="h3">
                    <a href="../loading/load.php" class="card-title">Men’s Course</a>
                  </h3>
        ...
        <section class="section about" aria-label="about" id="about"
          ...
          <div class="container">
            ...
            <div class="about-banner img-holder" style="--width: 470; --height:
              ...
              <a href="../payment gateway/appointment.php" class="btn btn-secondary">Meet Instructor</a>
            </div>
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-author">
                      <a href="../loading/load.php" class="card-link">
                        By: <span class="span">Michael Jordan</span>
                      </a>
                    </p>

                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Children Nutrition and
                        Cooking</a>
                    </h3>
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Introduction to Food and
                        Health.</a>
                    </h3>
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Nutrition and Lifestyle in
                        Pregnancy</a>
                    </h3>
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Expertise on Fitness,
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Hacking exercise for health
              ...
              <li>
                <div class="course-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="../loading/load.php" class="card-title">Designing Your Personal
                        Weight Loss Plan</a>
                    </h3>
